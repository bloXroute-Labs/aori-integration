...
func (c *gatewayClient) SubmitBeaconBlockSSZ(ctx context.Context, in *SubmitBeaconBlockSSZRequest, opts ...grpc.CallOption) (*SubmitBeaconBlockSSZReply, error) {
	out := new(SubmitBeaconBlockSSZReply)
	err := c.cc.Invoke(ctx, "/gateway.Gateway/SubmitBeaconBlockSSZ", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGatewayServer) SubmitBeaconBlockSSZ(context.Context, *SubmitBeaconBlockSSZRequest) (*SubmitBeaconBlockSSZReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitBeaconBlockSSZ not implemented")
}
...
func _Gateway_SubmitBeaconBlockSSZ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitBeaconBlockSSZRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).SubmitBeaconBlockSSZ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.Gateway/SubmitBeaconBlockSSZ",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).SubmitBeaconBlockSSZ(ctx, req.(*SubmitBeaconBlockSSZRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubmitBeaconBlockSSZ",
			Handler:    _Gateway_SubmitBeaconBlockSSZ_Handler,
		},
		{
